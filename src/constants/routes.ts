export const ROUTE_PATH = {
  ...
  MANAGE_PLANS: 'plans',
  MANAGE_PRODUCTION_TRACKING: 'production_tracking',
  MANAGE_WORKSHOP_COORDINATION_QC: 'workshop_coordination_qc',
  MANAGE_UPDATE_EQUIPMENT_STATUS: 'update_equipment_status',
  MANAGE_PRODUCTION_PROGRESS_REPORT: 'production_progress_report',
